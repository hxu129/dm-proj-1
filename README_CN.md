...
1.  `data/`：包含下载所需数据集的脚本。
    * 你需要通过[Hugging Face wiki40b 仓库](https://huggingface.co/datasets/google/wiki40b/tree/refs%2Fconvert%2Fparquet/en)下载数据集，然后将对应的parquet文件分别放在test和validation文件夹下，`merge_parquet.py`脚本会合并分片文件。
